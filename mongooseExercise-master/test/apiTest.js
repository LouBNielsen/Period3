let expect = require("chai").expect; //assertion libary
let connect = require("./plainMongoDriver");
let ObjectID = require("mongodb").ObjectID; //need for the test cases, man får ikke en String, men etObjectID
let fetch = require("node-fetch"); //quick way to make requests, det nye 'request' package
...
describe("Jokes API", function () {
  let server;
  //Start Server
  before(function (done) { //before class, execute before all tests
